...
const Footer = () => {
  ...
  return (
    <footer className="bg-fadedDarkBlue text-center p-4">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 py-8">
          ...
          <div>
            ...
            <p>
              PW IOI is dedicated to shaping the future of education with
              innovative approaches and excellence in teaching.
            </p>
          </div>
