  ...
  return (
    <main>
      <div>
        ...
        {/* Vision Section */}
        <div className="my-10 mx-auto max-w-7xl p-6 bg-fadedDarkBlue">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
            ...
            <div>
              ...
              <p>
                We at PW IOI campus aim to achieve everything that is beyond the
                scope of normal human imagination. With our innovative clubs and
                excellent faculty, we provide the students with everything they
                need to become an excelling mind in every field.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="my-10 mx-auto max-w-7xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white shadow-lg rounded-lg p-4">
              <Image
                src="/userlmn_2d625fb6ff6558278172899ad3a0fced.webp"
                alt="Blog Image 2"
                width={400}
                height={250}
                className="rounded-t-lg"
            ...
            <div className="bg-white shadow-lg rounded-lg p-4">
              ...
              <p className="text-gray-600">
                We have been organising competitions...
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-center mt-6">
            <Link
              href="#"
              className="inline-block bg-blue px-6 py-3 rounded text-white bg-blue-600 hover:bg-blue-700 transition duration-300"
            >
              Read More
            </Link>
          </div>
        ...
        {/* Results Section */}
        <div className="my-10 mx-auto max-w-4xl p-6 bg-fadedDarkBlue shadow-lg rounded-lg">
          ...
          <div className="flex justify-center">
            <Link href="#">
              <span className="inline-block bg-blue px-6 py-3 rounded text-white bg-blue-600 hover:bg-blue-700 transition duration-300">
                View Results
              </span>
            </Link>
          </div>
